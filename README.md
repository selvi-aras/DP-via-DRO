...
GitHub supplement of the paper _Differential Privacy via Distributionally Robust Optimization_ (`DPviaDRO`) by Aras Selvi, Huikang Liu, and Wolfram Wiesemann (2023). The paper has undergone a major revision, which is completed on the 23rd of May, 2024. All links are up-to-date, but we also include the earlier version of the manuscript in this repository.
